...
!(function (t, n) {
    ...
    (bt.defaultProps = { fill: 'none', x: 0, y: 0, r: 8, url: null, props: { x: 0, y: 0 } }),
        (pt.defaultProps = Object.assign({}, { sliderShape: 'bar', sliderType: 'value', minTemperature: 2200, maxTemperature: 11e3 }));
    function wt(e) {
        var r = ut(e).width,
            u = e.colors,
            ...
            a = { position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', borderRadius: '50%', boxSizing: 'border-box' };
        return h(
            gt,
            Object.assign({}, e, {
                onInput: function (t, n, i) {
            ...
            function (t, n, i) {
                return h(
                    'div',
                    Object.assign({}, n, { className: 'IroWheel', style: Object.assign({}, { width: vt(r), height: vt(r), position: 'relative' }, i) }),
                    h('div', {
                    ...
                    h('div', { className: 'IroWheelSaturation', style: Object.assign({}, a, { background: 'radial-gradient(circle closest-side, #fff, transparent)' }) }),
                    e.wheelLightness && h('div', { className: 'IroWheelLightness', style: Object.assign({}, a, { background: '#000', opacity: 1 - s.v / 100 }) }),
                    h('div', { className: 'IroWheelBorder', style: Object.assign({}, a, ft(e)) }),
                    u
                        .filter(function (t) {
                            return t !== l;
                        })
    ...
    var kt = (function (i) {
        function t(t) {
            ...
            i.call(this, t),
                ...
                (this.state = Object.assign({}, t, { color: this.color, colors: this.colors, layout: t.layout }));
        }
        return (
            i && (t.__proto__ = i),
            (((t.prototype = Object.create(i && i.prototype)).constructor = t).prototype.addColor = function (t, n) {
            ...
            (t.prototype.onColorChange = function (t, n) {
                this.setState({ color: this.color }), this.inputActive && ((this.inputActive = !1), this.emit('input:change', t, n)), this.emit('color:change', t, n);
            }),
            ...
            (t.prototype.render = function (t, e) {
                var u = this,
                    n = e.layout;
                return (
                    Array.isArray(n) || ((n = [{ component: wt }, { component: pt }]), e.transparency && n.push({ component: pt, options: { sliderType: 'alpha' } })),
                    h(
                        'div',
                        ...
                        n.map(function (t, n) {
                            var i = t.component,
                                r = t.options;
                            return h(i, Object.assign({}, e, r, { ref: void 0, onInput: u.emitInputEvent.bind(u), parent: u, index: n }));
                        })
                    )
                );
            }),
    ...
    var mt,
        ...
        jt,
        Mt,
        Ot = ((It.prototype = (mt = kt).prototype), Object.assign(It, mt), (It.I = mt), It);
    function It(n, t) {
        var i,
        ...
        return (
            (function (t, n, i) {
                ...
                m.i && m.i(t, n),
                    ...
                    (t = h(O, null, [t])),
                    (u = []),
                    k(n, r ? (n.n = t) : ((i || n).n = t), e || x, x, void 0 !== n.ownerSVGElement, i && !r ? [i] : e ? null : j.slice.call(n.childNodes), u, !1, i || x, r),
                    d(u, t);
            })(
                h(
                    mt,
