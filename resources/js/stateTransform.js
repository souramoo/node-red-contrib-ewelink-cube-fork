(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.stateTransform = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
"use strict";
...
var VERSION = exports.VERSION = "1.7.5";
...
},{"./helpers/bind.js":23,"_process":55,"timers":56}],51:[function(require,module,exports){
'use strict';
...
},{"base64-js":51,"buffer":52,"ieee754":53}],53:[function(require,module,exports){
"use strict";
...
function _unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return _arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? _arrayLikeToArray(r, a) : void 0; } }
function _arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; }
var rule = require('./protocolRule');
var _ = require('lodash');
var _require = require('./const'),
  CAPA_MAP = _require.CAPA_MAP;
var specialConvertCapabilityNames = ['startup'];
var specialRestoreCapabilityNames = ['toggle-startup'];
function _convertStartup(capabilityInfo) {
  ...
  if (Array.isArray(capabilityInfo.components)) {
    var _iterator = _createForOfIteratorHelper(capabilityInfo.components),
      _step;
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        var component = _step.value;
        if (component.capability !== 'toggle') continue;
        var convertCapabilityInfo = {
...
function _convertSpecialCapabilities(specialConvertCapabilities) {
  var convertCapabilities = [];
  var _iterator2 = _createForOfIteratorHelper(specialConvertCapabilities),
    _step2;
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      var capabilityInfo = _step2.value;
      var convertStartups = _convertStartup(capabilityInfo);
      if (convertStartups.length > 0) convertCapabilities.push.apply(convertCapabilities, _toConsumableArray(convertStartups));
    }
  } catch (err) {
    _iterator2.e(err);
  } finally {
...
function _restoreToggleStartup(toggleStartupCapabilities) {
  ...
  var baseRestoreToggleStartup = rule['toggle-startup'].restore(toggleStartupCapabilities[0]);
  var restoreToggleStartup = {
    capability: 'startup',
    permission: baseRestoreToggleStartup.permission,
    components: []
  };
  var _iterator3 = _createForOfIteratorHelper(toggleStartupCapabilities),
    _step3;
  try {
    for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
      var toggleStartupCapability = _step3.value;
...
function _restoreSpecialCapabilities(specialCapabilitiesRestore) {
  var restoreCapabilities = [];
  var toggleStartupCapabilities = [];
  var _iterator4 = _createForOfIteratorHelper(specialCapabilitiesRestore),
    _step4;
  try {
    for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
      var capabilityInfo = _step4.value;
  ...
  var toggleStartupConvert = _restoreToggleStartup(toggleStartupCapabilities);
 ...
 * @returns
 */
function v1CapabilityToV2Capability() {
  var capabilities = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
  var convertCapabilities = [];
  var needSpecialCapabilitiesConvert = [];
  var _iterator5 = _createForOfIteratorHelper(capabilities),
    _step5;
  try {
    for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
      var capabilityInfo = _step5.value;
  ...
  var specialCapabilitiesConverts = _convertSpecialCapabilities(needSpecialCapabilitiesConvert);
  if (specialCapabilitiesConverts.length > 0) convertCapabilities.push.apply(convertCapabilities, _toConsumableArray(specialCapabilitiesConverts));
  return convertCapabilities;
}
 ...
 * @returns
 */
function v2CapabilityToV1Capability() {
  var capabilities = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
  var restoreCapabilities = [];
  var needSpecialCapabilitiesRestore = [];
  var _iterator6 = _createForOfIteratorHelper(capabilities),
    _step6;
  try {
    for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
      var capabilityInfo = _step6.value;
      if (!rule[capabilityInfo.capability]) {
  ...
  var specialCapabilitiesRestores = _restoreSpecialCapabilities(needSpecialCapabilitiesRestore);
  if (specialCapabilitiesRestores.length > 0) restoreCapabilities.push.apply(restoreCapabilities, _toConsumableArray(specialCapabilitiesRestores));
  return restoreCapabilities;
}
function frontEndDataToV1Capability(capaData) {
  ...
  //     values: ['power']
  // }
  var toggleNum = parseInt(capaData.toggleNum);
  var result = [];
  var _iterator7 = _createForOfIteratorHelper(capaData.values),
    _step7;
  try {
    for (_iterator7.s(); !(_step7 = _iterator7.n()).done;) {
      var value = _step7.value;
      var found = _.find(CAPA_MAP, {
        capability: value
      });
      if (!found) {
        continue;
        ...
        if (value === 'toggle') {
          for (var i = 0; i < toggleNum; i++) {
            var copy = _.cloneDeep(found);
            _.set(copy, 'name', "".concat(i + 1));
            result.push(copy);
          }
        } else {
          result.push(found);
...
function frontEndDataToV2Capability(capaData) {
  var v1CapabilityData = frontEndDataToV1Capability(capaData);
  var v2CapabilityData = v1CapabilityToV2Capability(v1CapabilityData);
  return v2CapabilityData;
}
module.exports = {
  frontEndDataToV1Capability: frontEndDataToV1Capability,
  v1CapabilityToV2Capability: v1CapabilityToV2Capability,
  v2CapabilityToV1Capability: v2CapabilityToV1Capability,
  frontEndDataToV2Capability: frontEndDataToV2Capability
};

},{"./const":58,"./protocolRule":60,"lodash":54}],58:[function(require,module,exports){
"use strict";

/**
 * API server node - API prefix
 */
var API_PREFIX = 'ewelink-cube-api-v1';

/**
 * API URL - cache - add API server node
 */
var API_URL_CACHE_ADD_API_SERVER_NODE = "/".concat(API_PREFIX, "/cache/add-api-server-node");

/**
 * API URL - cache - remove API server node
 */
var API_URL_CACHE_REMOVE_API_SERVER_NODE = "/".concat(API_PREFIX, "/cache/remove-api-server-node");

/**
 * API URL - get bridge info
 */
var API_URL_GET_BRIDGE_INFO = "/".concat(API_PREFIX, "/get-bridge-info");

/** get bridge name */
var API_URL_GET_BRIDGE = "/".concat(API_PREFIX, "/bridge");

/**
 * API URL - get bridge token
 */
var API_URL_GET_BRIDGE_TOKEN = "/".concat(API_PREFIX, "/get-bridge-token");

/**
 * API URL - get device list
 */
var API_URL_GET_DEVICE_LIST = "/".concat(API_PREFIX, "/get-device-list");

/**
 * API URL - control device
 */
var API_URL_CONTROL_DEVICE = "/".concat(API_PREFIX, "/control-device");

/**
 * API URL - control device capalities
 */
var API_URL_CONTROL_CAPABILITIES_DEVICE = "/".concat(API_PREFIX, "/control-device-capalities");

/**
 * API URL - test token
 */
var API_URL_TEST_TOKEN = "/".concat(API_PREFIX, "/test-token");

/**
 * API URL - upload thirdparty device state
 */
var API_URL_UPLOAD_THIRDPARTY_DEVICE_STATE = "/".concat(API_PREFIX, "/upload-thirdparty-device-state");

/**
 * API URL - upload thirdparty device online
 */
var API_URL_UPLOAD_THIRDPARTY_DEVICE_ONLINE = "/".concat(API_PREFIX, "/upload-thirdparty-device-online");

/**
 * API URL - add third party device
 */
var API_URL_ADD_THIRDPARTY_DEVICE = "/".concat(API_PREFIX, "/add-thirdparty-device");

/**
 * API URL - ihost callback
 */
var API_URL_IHOST_CALLBACK = "/".concat(API_PREFIX, "/ihost-callback");

/**
 * SSE event - onAddDevice
 */
var EVENT_SSE_ON_ADD_DEVICE = 'EVENT_SSE_ON_ADD_DEVICE';

/**
 * SSE event - onUpdateDeviceInfo
 */
var EVENT_SSE_ON_UPDATE_DEVICE_INFO = 'EVENT_SSE_ON_UPDATE_DEVICE_INFO';

/**
 * SSE event - onDeleteDevice
 */
var EVENT_SSE_ON_DELETE_DEVICE = 'EVENT_SSE_ON_DELETE_DEVICE';

/**
 * SSE event - onUpdateDeviceState
 */
var EVENT_SSE_ON_UPDATE_DEVICE_STATE = 'EVENT_SSE_ON_UPDATE_DEVICE_STATE';

/**
 * SSE event - onUpdateDeviceOnline
 */
var EVENT_SSE_ON_UPDATE_DEVICE_ONLINE = 'EVENT_SSE_ON_UPDATE_DEVICE_ONLINE';

/**
 * Node-RED error event
 */
var EVENT_NODE_RED_ERROR = 'EVENT_NODE_RED_ERROR';

/**
 * security change
 */
var EVENT_SSE_SECURITY_CHANGE = 'EVENT_SSE_SECURITY_CHANGE';

/**
 * alarm change
 */
var EVENT_SSE_ALARM_CHANGE = 'EVENT_SSE_ALARM_CHANGE';

/**
 * Register device node tag item - current api server node ID
 */
var TAG_API_SERVER_NODE_ID = '__api_server_node_id';

/**
 * Register device node tag item - current register device node ID
 */
var TAG_REG_DEV_NODE_ID = '__reg_dev_node_id';

/**
 * Register device node tag item - device id
 */
var TAG_THIRDPARTY_DEVICE_ID = '__thirdparty_device_id';

/**
 * search local ip list
 */
var API_URL_SEARCH_IP_LIST = "/".concat(API_PREFIX, "/get-local-ip-list");

/**
 * get security mode
 */
var API_URL_GET_SECURITY_MODE_LIST = "/".concat(API_PREFIX, "/get_security_list");

/** Gateway mute */
var API_URL_SET_GATEWAY_MUTE = "/".concat(API_PREFIX, "/bridge_mute");

/** cancel Gateway mute */
var API_URL_CANCEL_GATEWAY_MUTE = "/".concat(API_PREFIX, "/bridge_unmute");

/**Cancel gateway alarm */
var API_URL_CANCEL_GATEWAY_ALARM = "/".concat(API_PREFIX, "/bridge_cancel_alarm");

/**Enable specified security mode */
var API_URL_ENABLE_SECURITY_MODE = "/".concat(API_PREFIX, "/securityId_enable");

/**Disable specified security mode */
var API_URL_DISABLE_SECURITY_MODE = "/".concat(API_PREFIX, "/securityId_disable");

/**One-click arming */
var API_URL_ONE_CLICK_ARMING = "/".concat(API_PREFIX, "/security_enable");

/**One-click disarm */
var API_URL_ONE_CLICK_DISARMING = "/".concat(API_PREFIX, "/security/disable");

/** hardware speaker */
var API_URL_HARDWARE_SPEAKER = "/".concat(API_PREFIX, "/rest/hardware/speaker");

/** system volume */
var API_URL_SET_SYSTEM_VOLUME = "/".concat(API_PREFIX, "/rest/bridge/config");

/** init query mdns */
var API_URL_QUERY_MDNS = "/".concat(API_PREFIX, "/query/mdns");
/**
 * Capabilities map
 */
var CAPA_MAP = [{
...
var V2_SUPPORT_CAPABILITIES = ['identify', 'thermostat', 'tamper-alert', 'voltage', 'electric-current', 'smoke', 'contact', 'motion', 'water-leak', 'window-detection', 'child-lock', 'anti-direct-blow', 'horizontal-swing', 'vertical-swing', 'eco', 'toggle-startup', 'detect-hold', 'toggle-identify', 'toggle-voltage', 'toggle-electric-current', 'toggle-electric-power', 'lqi', 'voc-index', 'gas', 'irrigation'];
module.exports = {
  API_PREFIX: API_PREFIX,
  API_URL_CACHE_ADD_API_SERVER_NODE: API_URL_CACHE_ADD_API_SERVER_NODE,
  API_URL_CACHE_REMOVE_API_SERVER_NODE: API_URL_CACHE_REMOVE_API_SERVER_NODE,
  API_URL_GET_BRIDGE_INFO: API_URL_GET_BRIDGE_INFO,
  API_URL_GET_BRIDGE_TOKEN: API_URL_GET_BRIDGE_TOKEN,
  API_URL_GET_DEVICE_LIST: API_URL_GET_DEVICE_LIST,
  API_URL_CONTROL_DEVICE: API_URL_CONTROL_DEVICE,
  API_URL_CONTROL_CAPABILITIES_DEVICE: API_URL_CONTROL_CAPABILITIES_DEVICE,
  API_URL_TEST_TOKEN: API_URL_TEST_TOKEN,
  API_URL_UPLOAD_THIRDPARTY_DEVICE_STATE: API_URL_UPLOAD_THIRDPARTY_DEVICE_STATE,
  API_URL_UPLOAD_THIRDPARTY_DEVICE_ONLINE: API_URL_UPLOAD_THIRDPARTY_DEVICE_ONLINE,
  API_URL_ADD_THIRDPARTY_DEVICE: API_URL_ADD_THIRDPARTY_DEVICE,
  API_URL_IHOST_CALLBACK: API_URL_IHOST_CALLBACK,
  EVENT_SSE_ON_ADD_DEVICE: EVENT_SSE_ON_ADD_DEVICE,
  EVENT_SSE_ON_DELETE_DEVICE: EVENT_SSE_ON_DELETE_DEVICE,
  EVENT_SSE_ON_UPDATE_DEVICE_INFO: EVENT_SSE_ON_UPDATE_DEVICE_INFO,
  EVENT_SSE_ON_UPDATE_DEVICE_ONLINE: EVENT_SSE_ON_UPDATE_DEVICE_ONLINE,
  EVENT_SSE_ON_UPDATE_DEVICE_STATE: EVENT_SSE_ON_UPDATE_DEVICE_STATE,
  EVENT_NODE_RED_ERROR: EVENT_NODE_RED_ERROR,
  TAG_API_SERVER_NODE_ID: TAG_API_SERVER_NODE_ID,
  TAG_REG_DEV_NODE_ID: TAG_REG_DEV_NODE_ID,
  TAG_THIRDPARTY_DEVICE_ID: TAG_THIRDPARTY_DEVICE_ID,
  CAPA_MAP: CAPA_MAP,
  API_URL_SEARCH_IP_LIST: API_URL_SEARCH_IP_LIST,
  API_URL_GET_SECURITY_MODE_LIST: API_URL_GET_SECURITY_MODE_LIST,
  EVENT_SSE_SECURITY_CHANGE: EVENT_SSE_SECURITY_CHANGE,
  EVENT_SSE_ALARM_CHANGE: EVENT_SSE_ALARM_CHANGE,
  API_URL_SET_GATEWAY_MUTE: API_URL_SET_GATEWAY_MUTE,
  API_URL_CANCEL_GATEWAY_MUTE: API_URL_CANCEL_GATEWAY_MUTE,
  API_URL_CANCEL_GATEWAY_ALARM: API_URL_CANCEL_GATEWAY_ALARM,
  API_URL_ENABLE_SECURITY_MODE: API_URL_ENABLE_SECURITY_MODE,
  API_URL_DISABLE_SECURITY_MODE: API_URL_DISABLE_SECURITY_MODE,
  API_URL_ONE_CLICK_ARMING: API_URL_ONE_CLICK_ARMING,
  API_URL_ONE_CLICK_DISARMING: API_URL_ONE_CLICK_DISARMING,
  API_URL_HARDWARE_SPEAKER: API_URL_HARDWARE_SPEAKER,
  API_URL_SET_SYSTEM_VOLUME: API_URL_SET_SYSTEM_VOLUME,
  API_URL_GET_BRIDGE: API_URL_GET_BRIDGE,
  API_URL_QUERY_MDNS: API_URL_QUERY_MDNS,
  V2_SUPPORT_CAPABILITIES: V2_SUPPORT_CAPABILITIES
};
...
var _require = require('./const'),
  API_URL_GET_DEVICE_LIST = _require.API_URL_GET_DEVICE_LIST;
function getDeviceInfo(_x, _x2) {
  return _getDeviceInfo.apply(this, arguments);
}
function _getDeviceInfo() {
  _getDeviceInfo = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(deviceId, serverId) {
    var deviceData, res, deviceList;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          deviceData = null;
          _context.prev = 1;
          _context.next = 4;
          return axios.post("http://127.0.0.1:1880".concat(API_URL_GET_DEVICE_LIST), {
            id: serverId
          });
        case 4:
          res = _context.sent;
          if (res.data.error === 0) {
            deviceList = JSON.parse(JSON.stringify(res.data.data.device_list));
            deviceData = deviceList.find(function (item) {
              return item.serial_number === deviceId;
            });
          }
          _context.next = 12;
          break;
        case 8:
          ...
          console.log('Get device info error : ', _context.t0);
          return _context.abrupt("return", deviceData);
        case 12:
          return _context.abrupt("return", deviceData);
        case 13:
        case "end":
...
},{"./const":58,"axios":1}],60:[function(require,module,exports){
"use strict";

function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
var toggleNames = ["open-window-detect", "child-lock", "horizontal-swing", "vertical-swing", "eco", "anti-direct-blow"];
var toggleCapabilities = ["window-detection"];
var oldToggleNameMap = {
  "open-window-detect": "window-detection"
};
var newCapabilityMap = {
  "window-detection": "open-window-detect"
};
var settingsPermissionKeys = {
  placeholder: "00",
  read: "01",
  configure: "10",
  readAndConfigure: "11"
};
var settingsTypeKeys = {
  "enum": "enum",
  numeric: "numeric",
  object: "object",
  "boolean": "boolean"
};
var newPermissionKeys = {
  placeholder: "0000",
  update: "1000",
  updated: "0100",
  configure: "0010",
...
var oldPermissionKeys = {
  write: 'write',
  readWrite: 'readWrite',
  read: 'read'
};
var permissionPerset = {
  write: '1000',
  readWrite: '1100',
  read: '0100'
};
var getConfigurePermission = function getConfigurePermission(settings) {
  var configurePermission = settingsPermissionKeys.placeholder;
  if (_typeof(settings) !== "object") return newPermissionKeys.placeholder;
  for (var _i = 0, _Object$values = Object.values(settings); _i < _Object$values.length; _i++) {
    var setting = _Object$values[_i];
  ...
  return [settingsPermissionKeys.configure, settingsPermissionKeys.readAndConfigure].includes(configurePermission) ? newPermissionKeys.configure : newPermissionKeys.placeholder;
};
var getFinalConfigurePermission = function getFinalConfigurePermission() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
    _ref$permission = _ref.permission,
    permission = _ref$permission === void 0 ? newPermissionKeys.placeholder : _ref$permission,
    _ref$queryPermission = _ref.queryPermission,
    queryPermission = _ref$queryPermission === void 0 ? newPermissionKeys.placeholder : _ref$queryPermission,
    _ref$configurePermiss = _ref.configurePermission,
    configurePermission = _ref$configurePermiss === void 0 ? newPermissionKeys.placeholder : _ref$configurePermiss;
  var finalConfigurePermission = parseInt(permission, 2) | parseInt(queryPermission, 2) | parseInt(configurePermission, 2);
  return finalConfigurePermission.toString(2).padStart(4, "0");
};
var commonConvert = function commonConvert() {
  var capabilityInfo = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var _ref2 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
    newPermission = _ref2.newPermission;
  var capability = capabilityInfo.capability,
  ...
  if (typeof name === 'string' && toggleNames.includes(name)) {
    var _oldToggleNameMap$nam;
    return {
      capability: (_oldToggleNameMap$nam = oldToggleNameMap[name]) !== null && _oldToggleNameMap$nam !== void 0 ? _oldToggleNameMap$nam : name,
...
var commonRestore = function commonRestore() {
  var capabilityInfo = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var capability = capabilityInfo.capability,
    name = capabilityInfo.name,
    permission = capabilityInfo.permission;
  ...
  var isWrite = permissionArr.splice(0, 1).includes("1");
  var isRead = permissionArr.includes("1");
  if (isWrite && isRead) {
  ...
  if (toggleNames.includes(capability) || toggleCapabilities.includes(capability)) {
    var _newCapabilityMap$cap;
    return {
      capability: 'toggle',
      permission: oldPermission,
      name: (_newCapabilityMap$cap = newCapabilityMap[capability]) !== null && _newCapabilityMap$cap !== void 0 ? _newCapabilityMap$cap : capability
    };
  }
  return {
    capability: capability,
...
module.exports = {
  ...
  'toggle-inching': {
    convert: function convert() {
      var capabilityInfo = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var configuration = capabilityInfo.configuration;
      var capability = commonConvert(capabilityInfo, {
        newPermission: newPermissionKeys.placeholder
      });
      if (configuration !== null && configuration !== void 0 && configuration.hasOwnProperty("supported")) {
        capability.settings = {
      ...
      var configurePermission = getConfigurePermission(capability === null || capability === void 0 ? void 0 : capability.settings);
      capability.permission = getFinalConfigurePermission({
        permission: capability.permission,
        configurePermission: configurePermission
      });
      return capability;
    },
    restore: function restore(capabilityInfo) {
      var _settings$toggleInchi;
      var settings = capabilityInfo.settings;
      var capability = commonRestore(capabilityInfo);
      if (settings !== null && settings !== void 0 && (_settings$toggleInchi = settings.toggleInchingSetting) !== null && _settings$toggleInchi !== void 0 && (_settings$toggleInchi = _settings$toggleInchi.value) !== null && _settings$toggleInchi !== void 0 && _settings$toggleInchi.hasOwnProperty("supported")) {
  ...
  percentage: {
    convert: function convert() {
      ...
      if (configuration) {
        ...
        if (configuration !== null && configuration !== void 0 && configuration.hasOwnProperty("range")) {
        ...
        if (configuration !== null && configuration !== void 0 && configuration.hasOwnProperty("increment")) {
    ...
    restore: function restore(capabilityInfo) {
      var settings = capabilityInfo.settings;
      var capability = commonRestore(capabilityInfo);
      if (settings !== null && settings !== void 0 && settings.hasOwnProperty("percentageRange")) {
        var _settings$percentageR, _settings$percentageR2, _settings$percentageR3;
        var configuration = {};
        if ((_settings$percentageR = settings.percentageRange) !== null && _settings$percentageR !== void 0 && _settings$percentageR.hasOwnProperty("min") && (_settings$percentageR2 = settings.percentageRange) !== null && _settings$percentageR2 !== void 0 && _settings$percentageR2.hasOwnProperty("max")) {
          configuration.range = {
            min: settings.percentageRange.min,
            max: settings.percentageRange.max
          };
        }
        if ((_settings$percentageR3 = settings.percentageRange) !== null && _settings$percentageR3 !== void 0 && _settings$percentageR3.hasOwnProperty("step")) {
  ...
  "thermostat-mode-detect": {
    convert: function convert() {
      ...
      var configuration = capabilityInfo.configuration;
      var capability = commonConvert(capabilityInfo, {
        newPermission: newPermissionKeys.updated
      });
      if (configuration) {
        var settings = {};
        if (configuration !== null && configuration !== void 0 && configuration.hasOwnProperty("supported")) {
        ...
        if (configuration !== null && configuration !== void 0 && configuration.hasOwnProperty("supportedModes")) {
    ...
    restore: function restore(capabilityInfo) {
      ...
      if (settings) {
        var configuration = {};
        if (settings !== null && settings !== void 0 && settings.hasOwnProperty("setpointRange")) {
          var _settings$setpointRan;
          configuration.supported = (_settings$setpointRan = settings.setpointRange.value) === null || _settings$setpointRan === void 0 ? void 0 : _settings$setpointRan.supported;
        }
        if (settings !== null && settings !== void 0 && settings.hasOwnProperty("supportedModes")) {
  ...
  "thermostat-target-setpoint": {
    ...
    restore: function restore() {
      var capabilityInfo = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var name = capabilityInfo.name,
        settings = capabilityInfo.settings;
      var capability = commonRestore(capabilityInfo);
      if (settings) {
        var configuration = {};
      ...
      if (configuration) {
        ...
        if (configuration.hasOwnProperty("calibration")) {
          settings.temperatureCalibration = {
            type: settingsTypeKeys.numeric,
            permission: settingsPermissionKeys.readAndConfigure,
            min: configuration.calibration.min,
            // 最小值
            max: configuration.calibration.max,
            // 最大值
            step: configuration.calibration.increment,
            // 温度调节步长，单位同temperatureUnit
  ...
  humidity: {
    ...
    restore: function restore() {
      ...
      var settings = capabilityInfo.settings;
      var capability = commonRestore(capabilityInfo);
      if (settings !== null && settings !== void 0 && settings.hasOwnProperty("humidityRange")) {
        capability.configuration = {
          range: {
  ...
  press: {
    convert: function convert() {
      ...
      var configuration = capabilityInfo.configuration;
      var capability = commonConvert(capabilityInfo);
      if (configuration !== null && configuration !== void 0 && configuration.hasOwnProperty("actions")) {
        capability.settings = {
          actions: {
            // 按键动作，可选。
            type: settingsTypeKeys["enum"],
    ...
    restore: function restore() {
      ...
      var settings = capabilityInfo.settings;
      var capability = commonRestore(capabilityInfo);
      if (settings !== null && settings !== void 0 && settings.hasOwnProperty("actions")) {
        capability.configuration = {
  ...
  'threshold-breaker': {
      ...
      if (configuration && configuration.hasOwnProperty("supported")) {
        capability.settings = {
          supportedSetting: {
            ...
            type: settingsTypeKeys.object,
            value: {
              supported: configuration === null || configuration === void 0 ? void 0 : configuration.supported
            }
          }
        };
      }
    ...
    restore: function restore() {
      var _settings$supportedSe;
      var capabilityInfo = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var settings = capabilityInfo.settings;
      var capability = commonRestore(capabilityInfo);
      if (!settings) return capability;
      capability.configuration = {
        supported: settings === null || settings === void 0 || (_settings$supportedSe = settings.supportedSetting) === null || _settings$supportedSe === void 0 || (_settings$supportedSe = _settings$supportedSe.value) === null || _settings$supportedSe === void 0 ? void 0 : _settings$supportedSe.supported
      };
      return capability;
    }
  },
  'inching': {
    convert: function convert() {
      ...
      capability.settings = {
        inchingEnable: {
          ...
          value: configuration === null || configuration === void 0 ? void 0 : configuration.enable
        },
        inchingSwitch: {
          permission: settingsPermissionKeys.readAndConfigure,
          type: settingsTypeKeys["enum"],
          value: configuration === null || configuration === void 0 ? void 0 : configuration.inchingSwitch,
          values: ["on", "off"]
        },
        inchingDelay: {
          type: settingsTypeKeys.numeric,
          permission: settingsPermissionKeys.readAndConfigure,
          min: configuration === null || configuration === void 0 ? void 0 : configuration.min_delay,
          max: configuration === null || configuration === void 0 ? void 0 : configuration.max_delay,
          value: configuration === null || configuration === void 0 ? void 0 : configuration.delay,
          unit: "ms"
        }
      };
    ...
    restore: function restore() {
      var _settings$inchingEnab, _settings$inchingSwit, _settings$inchingDela, _settings$inchingDela2, _settings$inchingDela3;
      var capabilityInfo = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var settings = capabilityInfo.settings;
      var capability = commonRestore(capabilityInfo);
      if (!settings) return capability;
      capability.configuration = {
        enable: settings === null || settings === void 0 || (_settings$inchingEnab = settings.inchingEnable) === null || _settings$inchingEnab === void 0 ? void 0 : _settings$inchingEnab.value,
        inchingSwitch: settings === null || settings === void 0 || (_settings$inchingSwit = settings.inchingSwitch) === null || _settings$inchingSwit === void 0 ? void 0 : _settings$inchingSwit.value,
        delay: settings === null || settings === void 0 || (_settings$inchingDela = settings.inchingDelay) === null || _settings$inchingDela === void 0 ? void 0 : _settings$inchingDela.value,
        min_delay: settings === null || settings === void 0 || (_settings$inchingDela2 = settings.inchingDelay) === null || _settings$inchingDela2 === void 0 ? void 0 : _settings$inchingDela2.min,
        max_delay: settings === null || settings === void 0 || (_settings$inchingDela3 = settings.inchingDelay) === null || _settings$inchingDela3 === void 0 ? void 0 : _settings$inchingDela3.max
      };
      return capability;
    }
  },
  "camera-stream": {
    ...
    restore: function restore() {
      var _settings$streamSetti, _settings$streamSetti2, _settings$streamSetti3, _settings$streamSetti4, _settings$streamSetti5, _settings$streamSetti6, _settings$streamSetti7, _settings$streamSetti8, _settings$streamSetti9;
      var capabilityInfo = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var settings = capabilityInfo.settings;
      var capability = commonRestore(capabilityInfo);
      if (!settings) return capability;
      capability.configuration = {
        username: settings === null || settings === void 0 || (_settings$streamSetti = settings.streamSetting) === null || _settings$streamSetti === void 0 || (_settings$streamSetti = _settings$streamSetti.value) === null || _settings$streamSetti === void 0 ? void 0 : _settings$streamSetti.username,
        password: settings === null || settings === void 0 || (_settings$streamSetti2 = settings.streamSetting) === null || _settings$streamSetti2 === void 0 || (_settings$streamSetti2 = _settings$streamSetti2.value) === null || _settings$streamSetti2 === void 0 ? void 0 : _settings$streamSetti2.password,
        streamUrl: settings === null || settings === void 0 || (_settings$streamSetti3 = settings.streamSetting) === null || _settings$streamSetti3 === void 0 || (_settings$streamSetti3 = _settings$streamSetti3.value) === null || _settings$streamSetti3 === void 0 ? void 0 : _settings$streamSetti3.streamUrl,
        videoCodec: settings === null || settings === void 0 || (_settings$streamSetti4 = settings.streamSetting) === null || _settings$streamSetti4 === void 0 || (_settings$streamSetti4 = _settings$streamSetti4.value) === null || _settings$streamSetti4 === void 0 ? void 0 : _settings$streamSetti4.videoCodec,
        resolution: settings === null || settings === void 0 || (_settings$streamSetti5 = settings.streamSetting) === null || _settings$streamSetti5 === void 0 || (_settings$streamSetti5 = _settings$streamSetti5.value) === null || _settings$streamSetti5 === void 0 ? void 0 : _settings$streamSetti5.resolution,
        keyFrameInterval: settings === null || settings === void 0 || (_settings$streamSetti6 = settings.streamSetting) === null || _settings$streamSetti6 === void 0 || (_settings$streamSetti6 = _settings$streamSetti6.value) === null || _settings$streamSetti6 === void 0 ? void 0 : _settings$streamSetti6.keyFrameInterval,
        audioCodec: settings === null || settings === void 0 || (_settings$streamSetti7 = settings.streamSetting) === null || _settings$streamSetti7 === void 0 || (_settings$streamSetti7 = _settings$streamSetti7.value) === null || _settings$streamSetti7 === void 0 ? void 0 : _settings$streamSetti7.audioCodec,
        samplingRate: settings === null || settings === void 0 || (_settings$streamSetti8 = settings.streamSetting) === null || _settings$streamSetti8 === void 0 || (_settings$streamSetti8 = _settings$streamSetti8.value) === null || _settings$streamSetti8 === void 0 ? void 0 : _settings$streamSetti8.samplingRate,
        dataRate: settings === null || settings === void 0 || (_settings$streamSetti9 = settings.streamSetting) === null || _settings$streamSetti9 === void 0 || (_settings$streamSetti9 = _settings$streamSetti9.value) === null || _settings$streamSetti9 === void 0 ? void 0 : _settings$streamSetti9.dataRate
      };
      return capability;
    }
  },
  mode: {
      ...
      if (configuration && configuration.hasOwnProperty("supportedValues")) {
        capability.settings = {
          supportedValues: {
            type: settingsTypeKeys["enum"],
            permission: settingsPermissionKeys.read,
            values: configuration === null || configuration === void 0 ? void 0 : configuration.supportedValues
          }
        };
        // 计算configure权限位，并合并权限
        var configurePermission = getConfigurePermission(capability === null || capability === void 0 ? void 0 : capability.settings);
    ...
    restore: function restore() {
      var _settings$supportedVa;
      var capabilityInfo = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var settings = capabilityInfo.settings;
      var capability = commonRestore(capabilityInfo);
      if (!settings) return capability;
      capability.configuration = {
        supportedValues: settings === null || settings === void 0 || (_settings$supportedVa = settings.supportedValues) === null || _settings$supportedVa === void 0 ? void 0 : _settings$supportedVa.values
      };
      return capability;
    }
  },
  "co2": {
    convert: function convert() {
      ...
      if (configuration && configuration.hasOwnProperty("range")) {
        var _configuration$range, _configuration$range2;
        capability.settings = {
          co2Range: {
            type: settingsTypeKeys.numeric,
            permission: settingsPermissionKeys.read,
            min: configuration === null || configuration === void 0 || (_configuration$range = configuration.range) === null || _configuration$range === void 0 ? void 0 : _configuration$range.min,
            max: configuration === null || configuration === void 0 || (_configuration$range2 = configuration.range) === null || _configuration$range2 === void 0 ? void 0 : _configuration$range2.max
          }
        };
        // 计算configure权限位，并合并权限
        var configurePermission = getConfigurePermission(capability === null || capability === void 0 ? void 0 : capability.settings);
    ...
    restore: function restore() {
      var _settings$co2Range, _settings$co2Range2;
      var capabilityInfo = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var settings = capabilityInfo.settings;
      var capability = commonRestore(capabilityInfo);
      if (!settings) return capability;
      capability.configuration = {
        range: {
          min: settings === null || settings === void 0 || (_settings$co2Range = settings.co2Range) === null || _settings$co2Range === void 0 ? void 0 : _settings$co2Range.min,
          max: settings === null || settings === void 0 || (_settings$co2Range2 = settings.co2Range) === null || _settings$co2Range2 === void 0 ? void 0 : _settings$co2Range2.max
        }
      };
      return capability;
    }
  ...
  "illumination": {
    convert: function convert() {
      ...
      var capability = commonConvert(capabilityInfo);
      if (configuration && configuration.hasOwnProperty("range")) {
        var _configuration$range3, _configuration$range4;
        capability.settings = {
          illuminationRange: {
            type: settingsTypeKeys.numeric,
            permission: settingsPermissionKeys.read,
            min: configuration === null || configuration === void 0 || (_configuration$range3 = configuration.range) === null || _configuration$range3 === void 0 ? void 0 : _configuration$range3.min,
            max: configuration === null || configuration === void 0 || (_configuration$range4 = configuration.range) === null || _configuration$range4 === void 0 ? void 0 : _configuration$range4.max
          }
        };
        // 计算configure权限位，并合并权限
        var configurePermission = getConfigurePermission(capability === null || capability === void 0 ? void 0 : capability.settings);
    ...
    restore: function restore() {
      var _settings$illuminatio, _settings$illuminatio2;
      var capabilityInfo = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var settings = capabilityInfo.settings;
      var capability = commonRestore(capabilityInfo);
      if (!settings) return capability;
      capability.configuration = {
        range: {
          min: settings === null || settings === void 0 || (_settings$illuminatio = settings.illuminationRange) === null || _settings$illuminatio === void 0 ? void 0 : _settings$illuminatio.min,
          max: settings === null || settings === void 0 || (_settings$illuminatio2 = settings.illuminationRange) === null || _settings$illuminatio2 === void 0 ? void 0 : _settings$illuminatio2.max
        }
      };
      return capability;
    }
  ...
  'motion': {
      ...
      if (configuration) {
        ...
        if (configuration.hasOwnProperty("motionInterval")) {
          capability.settings.motionInterval = {
            type: settingsTypeKeys.numeric,
            permission: settingsPermissionKeys.readAndConfigure,
            value: configuration === null || configuration === void 0 ? void 0 : configuration.motionInterval
          };
        }
        if (configuration.hasOwnProperty("motionSensitivity")) {
          capability.settings.motionSensitivity = {
            type: settingsTypeKeys.numeric,
            permission: settingsPermissionKeys.readAndConfigure,
            value: configuration === null || configuration === void 0 ? void 0 : configuration.motionSensitivity
          };
        }
        // 计算configure权限位，并合并权限
        var configurePermission = getConfigurePermission(capability === null || capability === void 0 ? void 0 : capability.settings);
    ...
    restore: function restore() {
      var _settings$motionInter, _settings$motionSensi;
      var capabilityInfo = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var settings = capabilityInfo.settings;
      var capability = commonRestore(capabilityInfo);
      if (!settings) return capability;
      capability.configuration = {
        motionInterval: settings === null || settings === void 0 || (_settings$motionInter = settings.motionInterval) === null || _settings$motionInter === void 0 ? void 0 : _settings$motionInter.value,
        motionSensitivity: settings === null || settings === void 0 || (_settings$motionSensi = settings.motionSensitivity) === null || _settings$motionSensi === void 0 ? void 0 : _settings$motionSensi.value
      };
      return capability;
    }
  },
  ...
  "detect-hold": {
      ...
      if (configuration) {
        ...
        if (configuration.hasOwnProperty("enabled")) {
          capability.settings.detectHoldEnable = {
            type: settingsTypeKeys["boolean"],
            permission: settingsPermissionKeys.read,
            value: configuration === null || configuration === void 0 ? void 0 : configuration.enabled
          };
        }
        if (configuration.hasOwnProperty("switch")) {
          capability.settings.detectHoldSwitch = {
            // 状态检测保持动作设置
            type: settingsTypeKeys["enum"],
            permission: settingsPermissionKeys.read,
            value: configuration === null || configuration === void 0 ? void 0 : configuration["switch"],
            values: ["on", "off"]
          };
        }
        if (configuration.hasOwnProperty("time")) {
          capability.settings.detectHoldTime = {
            // 状态检测保持时间设置
            type: settingsTypeKeys.numeric,
            permission: settingsPermissionKeys.read,
            min: 1,
            max: 359,
            value: configuration === null || configuration === void 0 ? void 0 : configuration.time,
            unit: "minute"
          };
        }
        // 计算configure权限位，并合并权限
    ...
    restore: function restore() {
      var _settings$detectHoldE, _settings$detectHoldS, _settings$detectHoldT;
      var capabilityInfo = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var settings = capabilityInfo.settings;
      var capability = commonRestore(capabilityInfo);
      if (!settings) return capability;
      capability.configuration = {
        enabled: settings === null || settings === void 0 || (_settings$detectHoldE = settings.detectHoldEnable) === null || _settings$detectHoldE === void 0 ? void 0 : _settings$detectHoldE.value,
        //启用、禁用超时未关能力
        "switch": settings === null || settings === void 0 || (_settings$detectHoldS = settings.detectHoldSwitch) === null || _settings$detectHoldS === void 0 ? void 0 : _settings$detectHoldS.value,
        //为开启，off 为闭合
        time: settings === null || settings === void 0 || (_settings$detectHoldT = settings.detectHoldTime) === null || _settings$detectHoldT === void 0 ? void 0 : _settings$detectHoldT.value //保持时间，[1,359]，单位：分钟，可设置范围1分钟-5小时59分
      };
      return capability;
    }
  },
  ...
  "toggle-power-consumption": {
      ...
      if (configuration) {
        ...
        if (configuration.hasOwnProperty("resolution")) {
          capability.settings.resolution = {
            type: settingsTypeKeys.numeric,
            permission: settingsPermissionKeys.read,
            value: configuration === null || configuration === void 0 ? void 0 : configuration.resolution
          };
        }
        if (configuration.hasOwnProperty("timeZoneOffset")) {
          capability.settings.timeZoneOffset = {
            // 状态检测保持动作设置
            type: settingsTypeKeys.numeric,
            permission: settingsPermissionKeys.read,
            min: -12,
            max: 14,
            value: configuration === null || configuration === void 0 ? void 0 : configuration.timeZoneOffset
          };
        }
        // 计算configure权限位，并合并权限
        var configurePermission = getConfigurePermission(capability === null || capability === void 0 ? void 0 : capability.settings);
    ...
    restore: function restore() {
      var _settings$resolution, _settings$timeZoneOff;
      var capabilityInfo = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var settings = capabilityInfo.settings;
      var capability = commonRestore(capabilityInfo, {
        oldPermission: "read"
      ...
      if (!settings) return capability;
      capability.configuration = {
        resolution: settings === null || settings === void 0 || (_settings$resolution = settings.resolution) === null || _settings$resolution === void 0 ? void 0 : _settings$resolution.value,
        //启用、禁用超时未关能力
        timeZoneOffset: settings === null || settings === void 0 || (_settings$timeZoneOff = settings.timeZoneOffset) === null || _settings$timeZoneOff === void 0 ? void 0 : _settings$timeZoneOff.value //为开启，off 为闭合
      };
      return capability;
    }
  },
...
var _require2 = require('../utils/device'),
  getDeviceInfo = _require2.getDeviceInfo;
var _require3 = require('../utils/capabilitiesTransform'),
  v2CapabilityToV1Capability = _require3.v2CapabilityToV1Capability;
...
function _frontEndDataToV2StateData(frontEndData) {
  ...
  switch (frontEndData.type) {
    case 'single':
      ...
      var power = {
        powerState: frontEndData.single
      };
      _.merge(v2StateData, {
        power: power
      });
    ...
    case 'multi':
      ...
      var multiObj = frontEndData.multi;
      for (var toggleIndex in multiObj) {
        var toggle = _defineProperty({}, toggleIndex, {
          toggleState: multiObj[toggleIndex]
        });
        _.merge(v2StateData, {
          toggle: toggle
        });
    ...
    case 'light':
      ...
      for (var item in frontEndData.light) {
        if (frontEndData.light[item]) {
          if ([item] == 'power') {
            var _power = {
              powerState: frontEndData.light[item]
            };
            _.merge(v2StateData, {
              power: _power
            });
            ...
            var brightness = {
              brightness: Number(frontEndData.light[item])
            };
            _.merge(v2StateData, {
            ...
            if (frontEndData.light.type === 'color-temperature') {
              var colorTemperatureObj = {
                colorTemperature: Number(frontEndData.light[item])
              };
              _.merge(v2StateData, {
                'color-temperature': colorTemperatureObj
              });
            } else if (frontEndData.light.type === 'color-rgb') {
              if (frontEndData.light.hslStr) {
                var _frontEndData$light$h = frontEndData.light.hslStr.match(/\d+/g).map(Number),
                  _frontEndData$light$h2 = _slicedToArray(_frontEndData$light$h, 3),
                  red = _frontEndData$light$h2[0],
                  green = _frontEndData$light$h2[1],
                  blue = _frontEndData$light$h2[2];
                var rgbObj = {
                  red: red,
                  green: green,
                  blue: blue
    ...
    case 'curtain':
      ...
      if (typeof frontEndData.curtain === 'string') {
        ...
        curtain = {
          percentage: {
            percentage: frontEndData.curtain
          }
        };
      }
    ...
    case 'lightStrip':
      ...
      // 开关
      var powerState = frontEndData.lightStripParams.power;
      var powerObj = {
      ...
      if (powerState === 'on') {
        ...
        if (frontEndData.lightStripParams.brightness) {
          var _brightness = {
            brightness: Number(frontEndData.lightStripParams.brightness)
          };
          _.merge(v2StateData, {
            brightness: _brightness
          });
        }
        var lightStripMode = frontEndData.lightStripParams.stripMode;
        // 色温
        if (lightStripMode === 'colorTemperature' && frontEndData.lightStripParams.colorTemp) {
          var _colorTemperatureObj = {
            'color-temperature': {
              colorTemperature: Number(frontEndData.lightStripParams.colorTemp)
            }
          };
          _.merge(v2StateData, _colorTemperatureObj);
        }
        // 颜色
        if (lightStripMode === 'color' && frontEndData.lightStripParams.hslStr) {
          var rgb = convertHexToRgb(frontEndData.lightStripParams.hslStr);
          var _rgb$match$map = rgb.match(/\d+/g).map(Number),
            _rgb$match$map2 = _slicedToArray(_rgb$match$map, 3),
            _red = _rgb$match$map2[0],
            _green = _rgb$match$map2[1],
            _blue = _rgb$match$map2[2];
          var _rgbObj = {
            red: _red,
            green: _green,
            blue: _blue
        ...
        // 模式
        var hasModeCapabilty = frontEndData.lightStripParams.hasModeCapabilty;
        if (hasModeCapabilty) {
          _.merge(v2StateData, {
            mode: {
              lightMode: {
    ...
    case 'thermostat':
      ...
      }, _thermostatChange(frontEndData));
      break;
    case 'ihost':
      _.merge({
        ihost: ihost
      }, {
        ihost: frontEndData.ihostParams
      });
      break;
    default:
      break;
...
function _thermostatChange(frontEndData) {
  ...
  if (frontEndData.thermostatParams['isTargetOrMode'] === 'targetTemperature' && frontEndData.thermostatParams['targetTemp']) {
    ...
    _.merge(v2StateData, _obj);
  } else if (frontEndData.thermostatParams['isTargetOrMode'] === 'thermostatMode' && frontEndData.thermostatParams['thermostatMode'] && frontEndData.thermostatParams['thermostatMode'] !== 'keep') {
    // set mode
    var thermostatObj = {
      thermostat: {
        'thermostat-mode': {
  ...
  var frostProtectionTemp = frontEndData.thermostatParams['frostProtectionTemp'];
  if (frostProtectionTemp) {
    ...
    _.merge(v2StateData, _obj2);
  }
  var childLock = frontEndData.thermostatParams['childLock'];
  if (childLock && childLock !== 'keep') {
    ...
    _.merge(v2StateData, _obj3);
  }
  var openWindowsDetect = frontEndData.thermostatParams['openWindowsDetect'];
...
function _isExistReverseOrKeep(v2Data) {
  var powerObj = _.get(v2Data.state, ['power'], {});
  var toggleObj = _.get(v2Data.state, ['toggle'], {});
  var powerAndToggleString = JSON.stringify(powerObj) + JSON.stringify(toggleObj);
...
function _v2StateDataToV1StateData(v2Data) {
  var _v2Data$state;
  var v1StateData = _.cloneDeep(v2Data.state);
  var specialNewCapabilities = ['window-detection', 'child-lock', 'horizontal-swing', 'vertical-swing', 'eco', 'anti-direct-blow'];
  var newCapabilities = ['smoke', 'contact', 'motion', 'water-leak', 'lqi'];
  var newCapability2ToggleName = {
    'window-detection': 'open-window-detect'
  };
  var deviceState = (_v2Data$state = v2Data.state) !== null && _v2Data$state !== void 0 ? _v2Data$state : {};
  var stateKeys = Object.keys(deviceState);
  var specialToggleStates = [];
  var toggleState;
  for (var _i = 0, _stateKeys = stateKeys; _i < _stateKeys.length; _i++) {
    var stateKey = _stateKeys[_i];
    ...
    if (stateKey === 'toggle') {
      ...
      var _newCapability2Toggle;
      var restoreStateKey = (_newCapability2Toggle = newCapability2ToggleName[stateKey]) !== null && _newCapability2Toggle !== void 0 ? _newCapability2Toggle : stateKey;
      specialToggleStates.push(_defineProperty({}, restoreStateKey, {
      ...
      v1StateData[stateKey] = {
        'thermostat-mode': {
          thermostatMode: deviceState[stateKey]['thermostat-mode']
        }
      };
    } else {
  ...
  if (specialToggleStates.length > 0) {
    ...
    var _iterator = _createForOfIteratorHelper(specialToggleStates),
      _step;
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        var specialToggleState = _step.value;
  ...
  var v1Capabilities = v2CapabilityToV1Capability(v2Data.capabilities);
  return {
    state: v1StateData,
...
function _v2StateDataToRealStateData(_x, _x2, _x3) {
  return _v2StateDataToRealStateData2.apply(this, arguments);
}
function _v2StateDataToRealStateData2() {
  _v2StateDataToRealStateData2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(v2Data, deviceId, serverId) {
    var deviceData, originState, state, capabilities, nowPowerState, originPowerState, toggleObj, originToggleObj, isAllKeepState, toggleIndex, originToggleState, toggleState;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return _context.abrupt("return", v2Data);
        case 2:
          _context.next = 4;
          return getDeviceInfo(deviceId, serverId);
        case 4:
          deviceData = _context.sent;
          originState = deviceData.state;
          state = v2Data.state, capabilities = v2Data.capabilities;
          for (capaKey in state) {
            if (capaKey === 'power') {
              nowPowerState = _.get(state, ['power', 'powerState'], 'off');
              if (nowPowerState === 'reverse') {
                originPowerState = _.get(originState, ['power', 'powerState'], 'off');
                state['power']['powerState'] = originPowerState === 'on' ? 'off' : 'on';
              }
            }
            if (capaKey === 'toggle') {
              toggleObj = _.get(state, ['toggle']);
              originToggleObj = _.get(originState, ['toggle'], {});
              isAllKeepState = Object.values(toggleObj).every(function (item) {
                return item.toggleState === 'keep';
              });
              if (isAllKeepState) {
                toggleObj = 'allKeepStateError';
              } else {
                for (toggleIndex in toggleObj) {
                  originToggleState = _.get(originToggleObj, [toggleIndex, 'toggleState']);
                  toggleState = _.get(toggleObj, [toggleIndex, 'toggleState']);
...
module.exports = {
  frontEndDataToV2StateData: frontEndDataToV2StateData,
  v2StateDataToV1StateData: v2StateDataToV1StateData,
  v2StateDataToRealStateData: v2StateDataToRealStateData
};

},{"../utils/capabilitiesTransform":57,"../utils/device":59,"../utils/tools":62,"lodash":54}],62:[function(require,module,exports){
"use strict";
...
function sleepSeconds(_x) {
  return _sleepSeconds.apply(this, arguments);
}
function _sleepSeconds() {
  _sleepSeconds = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(seconds) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
...
function sleepMillisecond(_x2) {
  return _sleepMillisecond.apply(this, arguments);
}
function _sleepMillisecond() {
  _sleepMillisecond = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(millisecond) {
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
