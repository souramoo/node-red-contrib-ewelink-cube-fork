...
class baseClass {
    ...
    async initSSE() {
        ...
        console.log('🚀 ~ file: baseClass.ts:320 ~ baseClass ~ initSSE ~ url -- v1', url);
        try {
    ...
    mountSseFunc(handler) {
        ...
        handler.onSecurityChange && this.event.addEventListener('security#v1#updateArmState', handler.onSecurityChange);
        handler.onAlarmChange && this.event.addEventListener('bridge#v1#updateAlarmState', handler.onAlarmChange);
    }
    unmountSseFunc() {
